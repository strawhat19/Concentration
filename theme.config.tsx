...
const config: DocsThemeConfig = {
  ...
  logo: <Logo title={`Concentration`} color={`hsl(var(--nextra-primary-hue)100% 50%/1)`} />,
  search: {
    placeholder: `Search...`
  },
  project: {
  ...
  docsRepositoryBase: 'https://github.com/strawhat19/Concentration/',
  footer: {
